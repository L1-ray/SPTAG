...
namespace SPTAG
{
    ...
    namespace SPANN
    {
        ...
        public:
            ...
            inline std::shared_ptr<SPTAG::COMMON::IQuantizer> GetPostingQuantizer() const {
                return m_pQuantizer;
            }
            ...
            ErrorCode SearchDiskIndex(QueryResult& p_query, SearchStats* p_stats = nullptr, std::set<int>* p_truth = nullptr) const;
