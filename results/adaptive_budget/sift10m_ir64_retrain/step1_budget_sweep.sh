#!/bin/bash
# step1_budget_sweep.sh - SIFT10M Budget Sweep with ir=64
# Config: SearchThreadNum=8, NumberOfThreads=16, InternalResultNum=64
...
echo "=========================================="
echo "SIFT10M Budget Sweep (ir=64)"
...
SearchResult=/home/ray/code/SPTAG/results/adaptive_budget/sift10m_ir64_retrain/search_results_b${b}.bin
...
DetailedIOStatsOutput=/home/ray/code/SPTAG/results/adaptive_budget/sift10m_ir64_retrain/budget_${b}.csv
