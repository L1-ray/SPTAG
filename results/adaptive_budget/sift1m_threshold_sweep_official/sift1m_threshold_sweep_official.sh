#!/bin/bash
# sift1m_threshold_sweep_official.sh - SIFT1M Threshold Sweep 严格缓存测试
# 配置: SearchThreadNum=8, NumberOfThreads=16, InternalResultNum=64 (官方对齐配置)

set -e

BASE_DIR="/home/ray/code/SPTAG"
RESULT_DIR="$BASE_DIR/results/adaptive_budget/sift1m_threshold_sweep_official"
...
SearchResult=/home/ray/code/SPTAG/results/adaptive_budget/sift1m_threshold_sweep_official/search_results_baseline.bin
...
DetailedIOStatsOutput=/home/ray/code/SPTAG/results/adaptive_budget/sift1m_threshold_sweep_official/baseline.csv
...
GenerateTruth=false
IndexDirectory=/home/ray/data/sift1m/spann_index_official_u8default_20260430
SearchResult=/home/ray/code/SPTAG/results/adaptive_budget/sift1m_threshold_sweep_official/search_results_learned.bin
HeadIndexFolder=head_index
...
SearchPostingPageLimit=4
EnableDetailedIOStats=true
DetailedIOStatsOutput=/home/ray/code/SPTAG/results/adaptive_budget/sift1m_threshold_sweep_official/learned.csv
DetailedIOStatsSampleRate=1.0
EnablePageCache=false
EnableInFlightCoalescing=true
...
echo "=========================================="
echo "SIFT1M Threshold Sweep (Official Config)"
echo "SearchThreadNum=8, NumberOfThreads=16, InternalResultNum=64"
