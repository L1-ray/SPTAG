...
## 瓶颈分析
- 结论: **读取放大显著，且与延迟相关**
- avg_latency_ms: 0.787
- p95_latency_ms: 0.898
- p99_latency_ms: 0.932
- avg_io_wait_ms: 0.000
- io_wait_ratio: 0.000
- corr(latency, requested_bytes): 0.785
- corr(latency, avg_queue_depth): -0.106

## 系统级信号
- avg_read_bandwidth_mbs: 525.110
- avg_cpu_iowait_percent: 10.029
- psi_io_some_delta_us: 5578011
- psi_io_full_delta_us: 5413564
